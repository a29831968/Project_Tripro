...
import tw.com.flag.tripro.Utils.SectionsStatePagerAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // set up setting list (such as, logout and editing)
        setupSettingsList();

        // set up bottom navigation
        setupBottomNavigationView();

        // set up all the needed fragments
        setupFragments();

        // check if the previous activity or fragment has extra
        getIncomingIntent();
    ...
    // this function is to see if the previous activity or fragment has extra, then it will check which fragment to go
    ...
    // put all the needed fragments into the pagerAdapter
