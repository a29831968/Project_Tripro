...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // check if the user can sign in or not
        // check if the account is verified from email or not
        // set up the button for navigating register page
        // if the account is available, then it will sign in and navigate to home page
        init();
                            ...
                            .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        try{
                                            // check if it is verified from email, if not, it will sign out directly
